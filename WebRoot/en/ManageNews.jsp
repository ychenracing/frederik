		...
		<!-- Nav -->
			...
			<header id="header" style="padding:3em 0 0 0;">
				<div class="logo container">
					<div>
						<h1><a href="" id="logo">Manage News</a>
                        </h1>
					</div>
				</div>
			</header>
											...
											<div class="12u">
												...
												<!-- Feature -->
													<section class="box feature">
														...
														<a href="en/DeleteANews.jsp?id=<%=newsItem.getId()%>&delete=true" class="button managebutton alt">delete</a>
														<a href="en/ModifyANews.jsp?id=<%=newsItem.getId()%>" class="button managebutton">modify</a>
														</div>
														</div>
													</section>
