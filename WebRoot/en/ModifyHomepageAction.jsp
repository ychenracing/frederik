<%@ page language="java" import="java.util.*,java.io.*,cn.edu.fudan.entity.*,cn.edu.fudan.model.*,cn.edu.fudan.function.*,javax.xml.parsers.*,javax.xml.transform.*,javax.xml.transform.dom.*,javax.xml.transform.stream.*,org.w3c.dom.*" pageEncoding="utf-8"%>
<%
...
<html>
  ...
  <% 
            ...
            document=builder.parse(this.getServletContext().getRealPath("/")+"en/xml/Homepage.xml");      
            document.normalize();   
      ...
      if(root.hasChildNodes())   
       ...
       /** 将document中的内容写入文件中   */
            ...
            /** 编码 */   
             ...
             StreamResult result = new StreamResult(new File(this.getServletContext().getRealPath("/")+"en/xml/Homepage.xml"));      
