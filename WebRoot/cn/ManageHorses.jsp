											...
											<div class="12u">
												...
												<!-- Feature -->
													<section class="box feature">
														...
														<a href="cn/DeleteAHorse.jsp?id=<%=horseItem.getId()%>&delete=true" class="button managebutton alt">删除</a>
														<a href="cn/ModifyAHorse.jsp?id=<%=horseItem.getId()%>" class="button managebutton">修改</a>
														</div>
														</div>
													</section>
