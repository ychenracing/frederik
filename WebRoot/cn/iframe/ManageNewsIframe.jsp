...
<html>
  ...
  <body>
   ...
   <a href="cn/PublishAnArticle.jsp" target="_blank" class="managePageDivLinkItem">发布新闻消息</a>
   </div>
   <div class="managePageDivItem" onmouseover="this.className='managePageDivItemHover'" onmouseout="this.className='managePageDivItem'">
   <a href="cn/ManageNews.jsp" target="_blank" class="managePageDivLinkItem">管理所有新闻</a>
   </div>
   </div>
  </body>
</html>
