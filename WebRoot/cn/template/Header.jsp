		...
		<script src="cn/js/jquery.dropotron.min.js"></script>
		<script src="cn/js/skel.min.js"></script>
		...
		<noscript>
			<link rel="stylesheet" href="cn/css/skel.css" />
    ...
    .slidesjs-pagination li a {
      ...
      height: 0;
      padding-top: 26px;
      background-image: url(cn/images/pagination_big.png);
