...
public class CnConvertSingleVideo {
	
	private String mencoder_home = this.getClass().getResource("/").getPath()+"../../videoConvertTools/mencoder.exe";//mencoder.exe所放的路径
	private String ffmpeg_home = this.getClass().getResource("/").getPath()+"../../videoConvertTools/ffmpeg.exe";//ffmpeg.exe所放的路径
	
	public String inputFile_home = this.getClass().getResource("/").getPath()+"../../cn/upload/video/";//需转换的文件的位置
	public String outputFile_home = this.getClass().getResource("/").getPath()+"../../cn/upload/video/";//转换后的文件所放的文件夹位置
	
	
	private String tempFile_home;//存放rm,rmvb等无法使用ffmpeg直接转换为 文件先转成的avi文件
	
	public static void main(String[] args){
		System.out.println(CnConvertSingleVideo.class.getResource("/").getPath()); 
	}
	 public CnConvertSingleVideo(String tempFilePath){
