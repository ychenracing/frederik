...
public class CnModifyHorseGallery extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CnModifyHorseGallery() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (modifyHorse.updateById(horse)) {
				response.sendRedirect("cn/Horse.jsp?id="+horseId);
			} else{
